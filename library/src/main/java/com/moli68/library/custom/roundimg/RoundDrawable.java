...
public class RoundDrawable extends Drawable {
     ...
     * @return the {@link RoundDrawable} for chaining.
     */
    public RoundDrawable setCornerRadius(float topLeft, float topRight, float bottomRight, float bottomLeft) {
    ...
    public RoundDrawable setScaleType(ScaleType scaleType) {
        if (scaleType == null) {
